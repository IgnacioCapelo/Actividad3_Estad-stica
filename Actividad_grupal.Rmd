...
```
Para hacer los resultados más visuales se pueden representar las cargas de cada variable gráficamente.
```{r}
...
fviz_contrib(pca_almnut_complete, choice = "var", axes = 2, top = 10, 
             title="Contribución de variables al componente principal 2")
...
```
(No he conseguido averiguar como hacer para añadir las variables sin que se solapen)
```{r}
library(pheatmap)
